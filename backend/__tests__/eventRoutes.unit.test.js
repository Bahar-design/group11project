...
describe('eventRoutes basic flows', () => {
  ...
  it('GET /api/events returns DB events when pool returns rows', async () => {
    const eventRow = { event_id: 10, event_name: 'DB Event', description: 'd', location: 'L', urgency: 2, event_date: new Date('2025-12-01'), volunteers: 5, skill_id: [7] };
  ...
  it('GET /api/events/:id returns event when found', async () => {
    const row = { event_id: 11, event_name: 'Single', description: 'd', location: 'L', urgency: 1, event_date: new Date('2025-11-11'), volunteers: 0, skill_id: [9] };
